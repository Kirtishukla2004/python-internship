...
btn4 = Button(win, text="+", bd=2).grid(row=1, column=4, ipadx=4, ipady=3)
...
btn3 = Button(win, text=2, bd=2).grid(row=2, column=3, ipadx=4, ipady=3)
btn4 = Button(win, text="-", bd=2).grid(row=2, column=4, ipadx=4, ipady=3)
...
btn4 = Button(win, text="*", bd=2).grid(row=3, column=4, ipadx=4, ipady=3)
btn1 = Button(win, text=0, bd=2).grid(row=4, column=1, ipadx=4, ipady=3)
btn2 = Button(win, text="C", bd=2).grid(row=4, column=2, ipadx=4, ipady=3)
btn3 = Button(win, text="=", bd=2).grid(row=4, column=3, ipadx=4, ipady=3)
btn4 = Button(win, text="/", bd=2).grid(row=4, column=4, ipadx=4, ipady=3)
